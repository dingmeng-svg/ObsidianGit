...
**编号重构：**
- L1 方法论层：18_外部方法论萃取与关系声明规范（原 15）
...
| Skill                      | 对应系统文档                                             |                 |
| :------------------------- | :------------------------------------------------- | --------------- |
| `atomic-note-extraction`   | 02_原子笔记炼金术, 06_Inbox 素材处理全流程规范, 19_外部方法论关系声明规范       |                 |
| `vault-management`         | 05_Vault Management 全流程操作规范, 05_Vault Management 全流程操作规范, 05_Vault Management 全流程操作规范 |                 |
...
详见 [[07_YAML FrontMatter 规范]]。Atom 笔记 Field 描述见 [[01_知识库统一规范总纲#tags|总纲 §标签体系]]。
