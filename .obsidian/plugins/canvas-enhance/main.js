...
var AutoResizeNodeCanvasExtension = class extends CanvasExtension {
  constructor() {
    super(...arguments);
    this.pendingResizes = /* @__PURE__ */ new Map();
  ...
  init() {
    ...
    this.plugin.registerEvent(this.plugin.app.workspace.on(
      ...
      (canvas, node, viewUpdate) => void this.onNodeTextContentChanged(canvas, node, viewUpdate.view.dom)
    ));
  }
...
var MindmapCanvasExtension = class extends CanvasExtension {
  ...
  createChildNode(canvas, force) {
    ...
    const y = children.length === 0 ? parent.y : children[children.length - 1].y + children[children.length - 1].height + this.siblingSpacing() + 20;
  ...
  rearrangeSiblings(canvas, parent) {
    ...
    for (let i = 0; i < children.length; i++) {
      const y = i === 0 ? parent.y + parent.height / 2 - totalHeight / 2 : children[i - 1].y + children[i - 1].height + ss;
